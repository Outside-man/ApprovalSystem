...
class FormClubActivityDao extends \core\lib\BaseDao {
    ...
    public function insert($club, $user, $activityName,
        ...
        try {
            ...
            values (:apply_date, :club, :chief_name, :chief_id, :chief_tel, :activity_name, :activity_place, :activity_time, :activity_people, :is_apply_fine, :activity_info, :apply_self_money, :apply_reserve_money, :club_id, :file_id)');
